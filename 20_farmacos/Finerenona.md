...
**Clase:** Antagonista **selectivo no esteroideo** del receptor de mineralocorticoides (ARM-ns).
**Marca:** Kerendia® (Bayer). Comprimidos de 10 mg (rosa) y 20 mg (amarillo).
**Estatus:** Triángulo negro (seguimiento adicional AEMPS).
...
- [[Espironolactona]] / [[Eplerenona]] (comparadores esteroideos)
- [[Hiperpotasemia]] (principal RAM)
