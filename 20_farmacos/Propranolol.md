...
tags: [farmaco, betabloqueante, cardio, digestivo, endocrino, neuro]
last_fact_checked: 2026-06-09
---
# Propranolol

**Clase:** Betabloqueante adrenérgico no selectivo (β1 + β2), de primera generación. Nombre comercial en España: Sumial.
...
**Ajuste renal:** usar con precaución; en insuficiencia renal significativa pueden aumentar los niveles plasmáticos (CIMA).
**Ajuste hepático:** en insuficiencia hepática grave **no superar 20 mg tres veces al día** (CIMA). En cirrosis con ascitis el techo de dosis es menor (160 mg/día, Manual Tabla 11, p. 519) y en ascitis refractaria se recomienda usarlo con precaución evitando dosis elevadas (Manual, cap. cirrosis).
