...
**Clase:** Anticoagulante Inyectable directo estándar (Heparina de Bajo Peso Molecular).
...
|---|---|---|---|
| Profilaxis TEV (cirugía mayor, paciente encamado) | 40 mg | SC | Cada 24h |
| Profilaxis TEV (bajo riesgo) | 20 mg | SC | Cada 24h |
| Tratamiento TVP/TEP | 1 mg/kg | SC | Cada 12h |
| Tratamiento TVP/TEP (pauta simplificada) | 1.5 mg/kg | SC | Cada 24h |
| SCA (SCASEST) | 1 mg/kg | SC | Cada 12h |
