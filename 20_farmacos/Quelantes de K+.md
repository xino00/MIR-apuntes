...
**Patiromer preferido si:** IC con congestión (evitar carga de Na⁺ del ciclosilicato).
**Ciclosilicato Zr preferido si:** necesidad de titulación rápida, sin congestión ni HTA refractaria.
**Resinas clásicas** se reservan para casos excepcionales (coste, pulsos cortos) — tolerancia limitada.
