...
1. **Marcadores de Daño Miocárdico (Troponinas - MDM):** Solicitar según la sospecha clínica y hallazgos del ECG. Un ECG normal inicial obliga a mantener alerta y esperar curva de troponinas.
2. **Radiografía de Tórax Urgente:** Aporta información vital en el 20% de los casos (ensanchamiento mediastínico, neumotórax, condensación, derrame).
3. **POCUS / Ecocardiograma (ETT):** Mandatorio si hay signos de gravedad y el diagnóstico es incierto (buscar Taponamiento, TEP masivo, disfunción ventricular severa, disección aórtica).
4. **Dímero D / Angio-TC:** Reservado para sospechas de TEP o Síndrome Aórtico Agudo basándose en escalas de probabilidad clínica (Wells, Geneva).
...
- **[[SCA - Evaluación Inicial y Clasificación|Síndrome Coronario Agudo]]:** Dolor opresivo irradiado. ECG: ST elevado/descendido, T picudas o invertidas.
