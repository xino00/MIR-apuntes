...
Se debe a la pérdida real de bicarbonato al exterior del cuerpo. Para compensar la carga negativa perdida sin crear aniones nuevos gruesos, el riñón reabsorbe masivamente ion **Cloruro** del plasma $\to$ Acidosis Hiperclorémica.
...
- **AGu Negativo (N):** *N*ormal. Responde el amonio. La causa es Extrarenal (Ej. Diarrea).
- **AGu Positivo (P):** *P*atología Renal. El riñón no puede excretar amoníaco. La causa es una Acidosis Tubular Renal (ATR).
...
> **Fórmula del Déficit de HCO3:** `0.5 × Peso (kg) × (HCO3 Deseado - HCO3 Actual)`
> *(Para el 'HCO3 Deseado' NO se pone 24. El objetivo de una urgencia es sacar de peligro al paciente marcando un "target seguro" de HCO3 de ~15 mEq/L).*
