...
tags: [urgencias, nefro, acido_base, fisiopatologia]
---
...
|---|---|---|
| **G** | **G**licoles (Etilenglicol, Propilenglicol) | Gap Osmolar > 10 |
| **O** | **O**xoprolina | Intoxicación masiva crónica por paracetamol |
...
| **M** | **M**etanol | Ceguera + Gap Osmolar |
| **A** | **A**spirina (Salicilatos) | Característica: Acidosis metabólica + Alcalosis respiratoria central simultáneas |
| **R** | Fallo **R**enal (*Renal Failure*, uremia) | Acúmulo de fosfatos y sulfatos; requiere FG < 20 para ensanchar el Gap |
| **K** | **K**etoacidosis | CAD, alcohólica o por ayuno; acetoacetato y β-hidroxibutirato |
...
> [!tip] Diferenciar GI vs renal con el Anión Gap Urinario (AGu)
> **`AGu = Na_u + K_u - Cl_u`**
> - **AGu Negativo (N):** **N**ormal. El amonio responde. Causa **extrarrenal** (ej. diarrea).
> - **AGu Positivo (P):** **P**atología renal. El riñón no excreta NH₄⁺. Causa = **ATR**.

---

## 💉 3. Tratamiento y Reposición de Bicarbonato

> [!important] Regla general: NO reponer bicarbonato en HAGMA leve-moderada
...
> [!danger] Calcular antes el potasio
...
> **Déficit de HCO₃⁻:** `0.5 × Peso (kg) × (HCO₃⁻ deseado - HCO₃⁻ actual)`
> *El "HCO₃⁻ deseado" NO es 24. Target seguro de urgencia: ~**15 mEq/L***.
