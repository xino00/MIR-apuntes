...
- **Acidosis Metabólica (Fórmula de Winter):** `pCO2 esperada = (1.5 × HCO3) + 8 [± 2]`
  - *Regla rápida:* La pCO2 esperada debe coincidir con los últimos decimales del pH (ej: pH 7.28, pCO2 esperada ~28).
- **Alcalosis Metabólica:** `pCO2 esperada = (0.7 × HCO3) + 21 [± 2]`

**Respiratorios (Compensación Renal - Lenta, tarda 3-5 días):**
- **Acidosis Respiratoria:** 
  - *Aguda:* Por cada 10 de $\uparrow$ pCO2 $\to$ El HCO3 sube **1** mEq/L.
  - *Crónica:* Por cada 10 de $\uparrow$ pCO2 $\to$ El HCO3 sube **3 a 4** mEq/L.
- **Alcalosis Respiratoria:**
  - *Aguda:* Por cada 10 de $\downarrow$ pCO2 $\to$ El HCO3 baja **2** mEq/L.
  - *Crónica:* Por cada 10 de $\downarrow$ pCO2 $\to$ El HCO3 baja **4 a 5** mEq/L.
...
> **Fórmula:** `Anión Gap (AG) = Na+ - (Cl- + HCO3-)`
...
### Paso 5: Calcular el Delta Ratio ($\Delta$/$\Delta$ Gap)
...
> **Fórmula:** `(AG Medido - 12) / (24 - HCO3 Medido)`
