...
*** Resumen Evolución.
Paciente de … años con los antecedentes personales descritos, acude a Urgencias por herida incisa/contusa a nivel de *****. Se realiza limpieza de herida con SSF y solución yodada (betadine). Bajo condiciones de asepsia y antisepsia se procede a la infiltración local de anestesia (Mepivacacaína 2%).
Exploración de herida, descartándose lesión de estructuras profundas. (si en extremidades -> musculo tendinosas/ confirmándose integridad de tendones extensores y flexores).
Cierre de herida mediante aproximación de bordes con puntos de sutura simple (X puntos Nylon 3/0 4/0 5/0) / Steri-strips / Grapas. Cobertura de herida con apósito y vendaje compresivo.
