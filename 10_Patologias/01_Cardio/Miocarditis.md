---
aliases: [Miocarditis, Miocarditis aguda, MCA, Miocarditis fulminante]
...
| **[[Miocardiopatías\|Miocardiopatía inflamatoria]]** | Miocarditis crónica con disfunción y remodelado ventricular; fenotipo hipocinético, dilatado o no dilatado, con/sin sustrato arritmogénico |
...
> [!warning] Miocarditis **complicada** (Tabla 3) — define un grupo de **riesgo alto**
...
> [!info] La etiología más común es **vírica** (§3.4.1)
...
> [!danger] Algoritmo de triaje en urgencias (Figura 5)
...
> 4. Si características de **riesgo alto** → **BEM (Clase I)**; si no → **RMC (Clase I)**.
...
> [!warning] Indicaciones de biopsia endomiocárdica (Tabla 6 de recomendaciones, **Clase I**)
...
> [!warning] No implantar DAI en la fase aguda
