---
aliases: [Síncope, Sincope, Pérdida Transitoria de Consciencia, PTC, Pre-síncope, Presíncope]
tags: [urgencias, cardio, patologia]
fuente: "Guía ESC 2018 sobre el diagnóstico y el tratamiento del síncope (Rev Esp Cardiol 2018;71(10):837.e1-e92) + Manual 12 Octubre 2022 cap. 13"
last_fact_checked: 2026-05-20
---
...
> [!warning] Características de **alto riesgo** en la evaluación inicial en urgencias
...
> [!success] Características de **bajo riesgo**
...
> [!note] Síndromes hemodinámicos del síncope reflejo
...
> El patrón hemodinámico **es independiente del factor desencadenante**: un síncope miccional o un vasovagal ortostático pueden ser cardioinhibitorios o vasodepresores.
...
4. **¿Existe evidencia de alto riesgo de evento cardiovascular grave o muerte?**
...
**b) Análisis de sangre** según sospecha clínica: hemograma, MDM o dímero D para descartar anemización, [[SCA - Evaluación Inicial y Clasificación|SCA]] o [[TEP - Tromboembolismo Pulmonar|TEP]] respectivamente.

> [!warning] Pruebas radiológicas y de laboratorio rutinarias (ESC 2018)
...
**k) Angio-TC pulmonar:** sospecha de [[TEP - Tromboembolismo Pulmonar|TEP]].
...
1. **¿Se puede identificar una causa subyacente grave?** Dirigir la asistencia a ese problema.
2. **¿Hay riesgo de desenlace adverso?** (Tabla 6, ya descrita arriba).
3. **¿Se debe ingresar al paciente?**

> [!info] Algoritmo de decisión tras la evaluación inicial en SU
> | Hallazgo | Estrategia recomendada |
> |---|---|
> | **Solo características de bajo riesgo** | Alta directa desde el SU (probablemente reflejo, situacional u ortostático). Si recurrente, derivación ambulatoria a consulta de síncope. |
> | **Sin características de alto ni de bajo riesgo** | **No** alta directa. Observación en unidad del SU (6-24 h con monitorización ECG) o en unidad de síncope; si está disponible, derivación rápida. |
> | **Cualquier característica de alto riesgo** | **No** alta directa. Estrategia diagnóstica intensiva: monitorización en servicio con capacidad de reanimación (6 h SU, hasta 24 h hospital). Tabla 7: valorar observación SU/US **vs** ingreso. |

> [!warning] Escalas de estratificación del riesgo
...
> [!note] Disminución espontánea de recurrencias (ESC 2018)
...
> [!info] Indicaciones de marcapasos en síncope reflejo (ESC 2018)
...
> [!warning] DAI en síncope con FEVI > 35% (novedad 2018)
...
> [!info] Modelo de atención en SU (novedad 2018)
...
> [!tip] Checklist mental ante un síncope en urgencias
> 1. **¿Es realmente un síncope?** Descartar epilepsia, psicogénico, AIT/HSA.
> 2. **ECG SIEMPRE.** Buscar: BAV, QT, Brugada, HVI/hipertrofia, ondas Q, ritmo, FC.
> 3. **TA en supino y bipedestación** (criterios HO: caída PAS ≥ 20, PAD ≥ 10 o PAS < 90 con síntomas).
> 4. **Estratificar:** revisar Tabla 6. ¿Alguna característica mayor?
> 5. **Decisión:**
...
> 6. **Si pasa el filtro inicial y persiste sin diagnóstico:** valorar ILR (Clase I-A) — no esperar a más recurrencias para implantarlo si la probabilidad de recurrencia es alta durante la vida del dispositivo.
> 7. **Tratamientos a recordar:**
