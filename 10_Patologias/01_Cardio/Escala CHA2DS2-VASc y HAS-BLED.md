...
### Indicación de anticoagulación (ESC 2024)

| Puntuación | Hombres | Mujeres | Actitud |
|---|---|---|---|
| 0 | 1 (solo sexo) | Sin anticoagulación |
| 1 | 2 | Considerar anticoagulación (valorar riesgo individual) |
| ≥2 | ≥3 | **Anticoagulación recomendada** (Clase I) |

> El sexo femenino **no puntúa aislado** — una mujer sin otros factores tiene CHA₂DS₂-VASc = 1 y NO requiere anticoagulación
...
|---|---|---|
| 0-2 | Bajo-moderado | Anticoagular según CHA₂DS₂-VASc |
