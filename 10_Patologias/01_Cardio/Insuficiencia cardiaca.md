...
fuente: "ESC HF 2021 (ehab368) + Focused Update 2023 (ehad195) + Manual 12 Octubre 2022 cap. 15 + Reddy 2018 H2FPEF (CIRCULATIONAHA.118.034646) + Pieske 2019 HFA-PEFF (ehz641)"
...
> [!info] Clasificación Clínica y Funcional
...
> [!info] Papel y limitaciones del ECG
> ECG 12 derivaciones es **Clase I-C** como prueba inicial. Útil para detectar FA, ondas Q de IAM previo, BRI, HVI, bajo voltaje (amiloidosis).
> **Un ECG normal NO descarta IC** — especialmente en IC-FEVIp, donde con frecuencia es normal o inespecífico. El descarte objetivo se hace con **NT-proBNP/BNP**, no con el trazado.

### Péptidos natriuréticos — puntos de corte

**Contexto no agudo (consulta / primaria):**

| Biomarcador | Corte de descarte |
|---|---|
| **BNP** | < 35 pg/mL |
| **NT-proBNP** | < 125 pg/mL |
...
| Biomarcador | Rule-out | Rule-in |
|---|---|---|
| **BNP** | < 100 pg/mL | ≥ 100 pg/mL |
| **NT-proBNP** | < 300 pg/mL | **> 450 pg/mL si < 55 años**<br>**> 900 pg/mL si 55-75 años**<br>**> 1800 pg/mL si > 75 años** |
...
| Bloque | Parámetros |
|---|---|
| **Hemograma** | Serie roja, blanca, plaquetas (anemia como comorbilidad agravante) |
| **Función renal** | Urea, creatinina, Na, K (baseline antes de iSRAA/ARM) |
| **Metabólico** | Glucemia en ayunas + HbA1c |
| **Hepático** | Transaminasas, GGT, bilirrubina (congestión hepática vs hepatopatía) |
| **Tiroides** | TSH (hipo/hipertiroidismo como causa o agravante) |
| **Lipídico** | Colesterol total, LDL, HDL, TG |
| **Hierro** | **Ferritina + IST (TSAT)** — si ferropenia con/sin anemia y FEVI < 45-50% → ferroterapia IV |
| **Biomarcador cardíaco** | BNP o NT-proBNP (I-B) |
...
| Variable | Puntos |
|---|---|
| **H**eavy — IMC > 30 kg/m² | 2 |
| **H**ypertensive — tratamiento con ≥ 2 antihipertensivos | 1 |
| atrial **F**ibrillation | 3 |
| **P**ulmonary hypertension — PAP sistólica > 35 mmHg | 1 |
| **E**lder — edad > 60 años | 1 |
...
Abordaje escalonado **P-E-F-F**: **P**re-test → **E**chocardiographic & natriuretic peptide score → **F**unctional testing (eco de ejercicio) → **F**inal etiology. Integra hallazgos:
