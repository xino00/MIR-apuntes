...
**Etiquetas:** #patologia #neurologia #cefalea #SNOOP10

---

> [!important] 🚨 Signos de Alarma: SNOOP10
> *Ante cualquier "Red Flag", se debe solicitar prueba de imagen (TAC/RMN) y valorar remitir a Neurología/Urgencias.*
> 1. **S**istémico: Fiebre, pérdida de peso, cáncer, VIH.
> 2. **S**ecundario: Antecedente de riesgo (trauma, neoplasia).
> 3. **N**eurológico: Déficit focal (motor/sensitivo), alteración nivel consciencia, papiledema.
> 4. **O**nset (Inicio): Súbito ("Cefalea en trueno"), < 1 min para intensidad máx.
> 5. **O**lder (Edad): Inicio > 50 años.
