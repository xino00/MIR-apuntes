...
> Acudir a Urgencias si: coloración amarillenta (ictericia), fiebre >38ºC, dolor intenso no controlado.

## Diagnóstico

**Resumen diferencial de patología biliar:**

| Entidad | Clínica | Ictericia | Fiebre | Analítica | Ecografía | Destino |
|---|---|---|---|---|---|---|
| **Cólico biliar** (obstrucción incompleta) | Dolor cólico HCD | NO | NO | Normal | No urgente | Alta ambulatoria |
| **Coledocolitiasis** | Dolor cólico HCD | +/- | +/- | Colestasis elevada | Urgente | INGRESO |
| **Colangitis** | Tríada de Charcot: dolor HCD + ictericia + fiebre | SÍ | SÍ | Leucocitosis, colestasis | Urgente | INGRESO |
| **Colecistitis** | Dolor cólico HCD + Murphy + fiebre | NO (salvo coledocolitiasis asociada) | SÍ | Leucocitosis | Urgente | INGRESO (Cirugía General) |
