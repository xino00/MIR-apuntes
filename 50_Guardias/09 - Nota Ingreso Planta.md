---
aliases: [Nota de ingreso, Ingreso planta, Plantilla ingreso]
tags: [plantilla, guardia, ingreso]
description: Plantilla de nota de ingreso en planta (versión intermedia)
---
...
Fecha de ingreso: DD/MM/AAAA · ___:___ h

## Resumen del paciente
Paciente varón/mujer de ___ años. Ingresa a cargo de [servicio] desde
[urgencias/derivación] para [motivo de ingreso / estudio].
...
## Enfermedad actual
[Cronología del cuadro: inicio, características, factores desencadenantes,
síntomas acompañantes y evolución hasta el ingreso. Anamnesis dirigida por
aparatos relevante. Qué niega.]
