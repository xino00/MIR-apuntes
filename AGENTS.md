...
- Config: `.github/quartz.config.ts` (colores estilo Codex, locale es-ES, SPA, popovers, KaTeX)
...
- `.Codex/settings.local.json` — configuración local de Codex
...
- Place custom agents in `.Codex/agents/` not `agents/`
- Never overwrite AGENTS.md when creating new agents
