---
title: EPOC — Exacerbación y Manejo Agudo
aliases: [Exacerbación EPOC, EPOC agudizado, EPOC reagudizado, Agudización EPOC, Reagudización EPOC, Broncospasmo agudo EPOC, Ingreso EPOC]
type: patologia
tags: [neumo, urgencias, epoc, patologia]
fuente: "GOLD 2026 + PROA FJD + Manual 12 Octubre 2022"
...
> [!danger] ⚡ Guardia
> - **Gravedad (Roma):** leve / moderada / grave según VAS, FR, FC, SaO₂, PCR (+ gasometría). Grave = PaO₂ ≤60 y/o acidosis (pH <7,35 + PaCO₂ >45).
> - **O₂ objetivo 88–92 %** (retenedor de CO₂; ojo con flujos altos). **HFNT** 1.ª línea si hipoxemia; **VMNI** si pH ≤7,35 + PaCO₂ ≥45.
> - **Broncodilatador de rescate:** SABA (salbutamol) + SAMA (ipratropio) inhalados/nebulizados.
> - **Corticoide:** prednisona 40 mg/24h × 5 días.
> - **Antibiótico si ≥2 de 4** (disnea, fiebre, ↑volumen esputo, ↑purulencia) — **uno debe ser purulencia** — o si precisa ventilación mecánica.
...
> [!tip] Eosinófilos como guía (GOLD 2026)
...
4. Presencia de **comorbilidades graves** agudizadas ([[Insuficiencia cardiaca]], neumonía grave, [[Arritmias|arritmia]] nueva).
